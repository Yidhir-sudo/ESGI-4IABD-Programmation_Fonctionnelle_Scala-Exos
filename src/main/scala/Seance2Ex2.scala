...
object Seance2Ex2 {
  def main(args: Array[String]): Unit = {
    ...
    // Ajout en tête
    val tempsListeHead = tempsExecution { 0 +: liste }
    val tempsVectorHead = tempsExecution { 0 +: vecteur }

    // Ajout en fin
    val tempsListeTail = tempsExecution { liste :+ 0 }
    val tempsVectorTail = tempsExecution { vecteur :+ 0 }
